; VERIFIQ v1.3.0 Installer Script (Inno Setup 6+)
; BBMW0 Technologies
; BEFORE RUNNING: publish the app in Visual Studio first:
;   Right-click VERIFIQ.Desktop → Publish → Folder → publish\VERIFIQ-v1.3.0
...
OutputBaseFilename=VERIFIQ-v1.3.0-Setup
...
[Files]
Source: "publish\VERIFIQ-v1.3.0\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
