...
public class PropertyRequirement
{
    ...
    // Extended properties used by ClassificationCodeLibrary lookup
    public string    IfcClass               { get; set; } = string.Empty;
    public CheckLevel CheckLevel            { get; set; }
    public CountryMode CountryApplicability { get; set; }
    public string    ExpectedValue          { get; set; } = string.Empty;
    public CorenetGateway GatewayApplicability { get; set; }
}
