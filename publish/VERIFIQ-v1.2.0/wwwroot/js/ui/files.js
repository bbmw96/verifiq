  ...
  function render() {
    return `
      <div>
        ...
        <div class="card">
          <div style="display:flex;align-items:center;gap:20px;margin-bottom:20px">
            ...
            <div>
              ...
              <div style="font-size:12px;color:var(--light-grey)">Version 1.2.0 &nbsp;|&nbsp; BBMW0 Technologies</div>
            </div>
          </div>
          ...
          <div class="detail-panel">
            <div class="detail-row">
              ...
              <span class="detail-value"><strong>1.2.0</strong> — Released April 2026</span>
            </div>
            <div class="detail-row">
              <span class="detail-label">Founder / Creator</span>
              <span class="detail-value"><strong>Jia Wen Gan</strong></span>
            </div>
            <div class="detail-row">
              <span class="detail-label">Founding Organisation</span>
              <span class="detail-value">Kyoob Architects Pte Ltd, Singapore</span>
            </div>
            <div class="detail-row">
        ...
        <div class="card">
          <div class="card-header"><span class="card-title">Version 1.0: Current Capabilities</span></div>
          <div class="table-wrap">
            <table>
              ...
              <tbody>
                ...
                <tr><td>IFC Property Editing</td><td>Fix missing or incorrect properties directly in VERIFIQ without returning to the BIM authoring tool</td><td><span class="badge badge-info">Planned: v1.1</span></td></tr>
                <tr><td>Native PDF Generation</td><td>Full PdfSharpCore-generated PDF without browser print step</td><td><span class="badge badge-info">Planned: v1.1</span></td></tr>
        ...
        <div class="card">
          ...
          <div class="table-wrap">
            <table>
              ...
              <tbody>
                <tr>
                  <td><span class="badge badge-pass">v1.2.0</span></td>
        ...
        <div class="card" style="background:var(--light-bg)">
          <p style="font-size:11px;color:var(--light-grey);text-align:center;line-height:1.8">
            VERIFIQ is developed by BBMW0 Technologies and was conceived by Jia Wen Gan of Kyoob Architects Pte Ltd, Singapore.<br>
